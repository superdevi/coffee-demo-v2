...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Za(e,t,n){let r=new Float32Array(La),i=new q(0,1,0);return new Di({name:`SphericalGaussianBlur`,defines:{n:La,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:eo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Qa(){return new Di({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:eo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function $a(){return new Di({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:eo(),fragmentShader:`
	...
	`}var to=class extends Mt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new pi([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
    ...
    `}),u=new di(c,l);n.add(u);let d=new Float32Array(400*6),f=new Float32Array(400*6),p=new fr;p.setAttribute(`position`,new Zn(d,3)),p.setAttribute(`color`,new Zn(f,3)),p.setDrawRange(0,0);let m=new ai(p,new qr({vertexColors:!0,transparent:!0,opacity:.35,blending:2,depthWrite:!1}));n.add(m);let h=new yi(2.85,2.9,64),g=new Cr({color:Bc,transparent:!0,opacity:.12,side:2,blending:2}),_=new Fr(h,g);n.add(_);let v=new Fr(new yi(1.95,1.98,64),g.clone());v.material.opacity=.07,n.add(v);let y=new K(9999,9999),b=new q,x=new va,S=new Hr(new q(0,0,1),0);function C(e){let t=e.touches?e.touches[0].clientX:e.clientX,n=e.touches?e.touches[0].clientY:e.clientY;y.x=t/window.innerWidth*2-1,y.y=-(n/window.innerHeight)*2+1}function w(){y.set(9999,9999)}window.addEventListener(`pointermove`,C,{passive:!0}),window.addEventListener(`touchmove`,C,{passive:!0}),document.addEventListener(`mouseleave`,w);function T(){let e=window.innerWidth,n=window.innerHeight;t.setSize(e,n),r.aspect=e/n,r.updateProjectionMatrix(),l.uniforms.uPixelRatio.value=t.getPixelRatio()}window.addEventListener(`resize`,T),T();let E=new xa,D=c.attributes.position;function O(){requestAnimationFrame(O);let e=E.getElapsedTime();x.setFromCamera(y,r),x.ray.intersectPlane(S,b);for(let t=0;t<Uc;t++){let n=s[t];n.angle+=n.speed*.008;let r=Math.sin(e*.5+t)*.08,i=Math.cos(n.angle)*(n.radius+r),a=n.baseY+Math.sin(e*.3+n.angle*2)*.2,o=Math.sin(n.angle)*n.radius*.3,c=i-b.x,l=a-b.y,u=Math.sqrt(c*c+l*l);if(u<Kc&&u>.01){let e=(1-u/Kc)*.8;i+=c/u*e,a+=l/u*e}D.array[t*3]=i,D.array[t*3+1]=a,D.array[t*3+2]=o}D.needsUpdate=!0;let i=0;for(let e=0;e<Uc&&i<400;e++)for(let t=e+1;t<Uc&&i<400;t++){let n=D.array[e*3],r=D.array[e*3+1],a=D.array[e*3+2],o=D.array[t*3],s=D.array[t*3+1],c=D.array[t*3+2],l=Math.sqrt((n-o)**2+(r-s)**2+(a-c)**2);if(l<Gc){let e=i*6;d[e]=n,d[e+1]=r,d[e+2]=a,d[e+3]=o,d[e+4]=s,d[e+5]=c;let t=1-l/Gc;f[e]=Bc.r*t,f[e+1]=Bc.g*t,f[e+2]=Bc.b*t,f[e+3]=Bc.r*t,f[e+4]=Bc.g*t,f[e+5]=Bc.b*t,i++}}p.setDrawRange(0,i*2),p.attributes.position.needsUpdate=!0,p.attributes.color.needsUpdate=!0,_.rotation.z=e*.05,v.rotation.z=-e*.03,r.position.x=Math.sin(e*.1)*.15,r.position.y=Math.cos(e*.08)*.1,r.lookAt(0,0,0),t.render(n,r)}O()}qc(document.getElementById(`bg-canvas`));var Jc=document.getElementById(`nickname`),Yc=document.getElementById(`company`);Jc.value=t(),Yc.value=n(),Jc.addEventListener(`input`,()=>a(Jc.value)),Yc.addEventListener(`input`,()=>i(Yc.value)),document.getElementById(`lb-open`).addEventListener(`click`,async()=>{let e=document.createElement(`div`);e.className=`lb-overlay`,e.innerHTML=`
