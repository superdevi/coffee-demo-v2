...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Xa(e,t,n){let r=new Float32Array(Ia),i=new J(0,1,0);return new Ti({name:`SphericalGaussianBlur`,defines:{n:Ia,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:$a(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Za(){return new Ti({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:$a(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Qa(){return new Ti({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:$a(),fragmentShader:`
	...
	`}var eo=class extends jt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new fi([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
    ...
    `}),u=new ui(c,l);n.add(u);let d=new Float32Array(400*6),f=new Float32Array(400*6),p=new dr;p.setAttribute(`position`,new Xn(d,3)),p.setAttribute(`color`,new Xn(f,3)),p.setDrawRange(0,0);let m=new ii(p,new Kr({vertexColors:!0,transparent:!0,opacity:.35,blending:2,depthWrite:!1}));n.add(m);let h=new q(9999,9999),g=new J,_=new _a,v=new Vr(new J(0,0,1),0);function y(e){let t=e.touches?e.touches[0].clientX:e.clientX,n=e.touches?e.touches[0].clientY:e.clientY;h.x=t/window.innerWidth*2-1,h.y=-(n/window.innerHeight)*2+1}function b(){h.set(9999,9999)}window.addEventListener(`pointermove`,y,{passive:!0}),window.addEventListener(`touchmove`,y,{passive:!0}),document.addEventListener(`mouseleave`,b);function x(){let e=window.innerWidth,n=window.innerHeight;t.setSize(e,n),r.aspect=e/n,r.updateProjectionMatrix(),l.uniforms.uPixelRatio.value=t.getPixelRatio()}window.addEventListener(`resize`,x),x();let S=new ba,C=c.attributes.position;function w(){requestAnimationFrame(w);let e=S.getElapsedTime();_.setFromCamera(h,r),_.ray.intersectPlane(v,g);for(let t=0;t<Hc;t++){let n=s[t];n.angle+=n.speed*.008;let r=Math.sin(e*.5+t)*.08,i=Math.cos(n.angle)*(n.radius+r),a=n.baseY+Math.sin(e*.3+n.angle*2)*.2,o=Math.sin(n.angle)*n.radius*.3,c=i-g.x,l=a-g.y,u=Math.sqrt(c*c+l*l);if(u<Gc&&u>.01){let e=(1-u/Gc)*.8;i+=c/u*e,a+=l/u*e}C.array[t*3]=i,C.array[t*3+1]=a,C.array[t*3+2]=o}C.needsUpdate=!0;let i=0;for(let e=0;e<Hc&&i<400;e++)for(let t=e+1;t<Hc&&i<400;t++){let n=C.array[e*3],r=C.array[e*3+1],a=C.array[e*3+2],o=C.array[t*3],s=C.array[t*3+1],c=C.array[t*3+2],l=Math.sqrt((n-o)**2+(r-s)**2+(a-c)**2);if(l<Wc){let e=i*6;d[e]=n,d[e+1]=r,d[e+2]=a,d[e+3]=o,d[e+4]=s,d[e+5]=c;let t=1-l/Wc;f[e]=zc.r*t,f[e+1]=zc.g*t,f[e+2]=zc.b*t,f[e+3]=zc.r*t,f[e+4]=zc.g*t,f[e+5]=zc.b*t,i++}}p.setDrawRange(0,i*2),p.attributes.position.needsUpdate=!0,p.attributes.color.needsUpdate=!0,r.position.x=Math.sin(e*.1)*.15,r.position.y=Math.cos(e*.08)*.1,r.lookAt(0,0,0),t.render(n,r)}w()}Kc(document.getElementById(`bg-canvas`));var qc=document.getElementById(`nickname`),Jc=document.getElementById(`company`);qc.value=t(),Jc.value=n(),qc.addEventListener(`input`,()=>a(qc.value)),Jc.addEventListener(`input`,()=>i(Jc.value)),document.getElementById(`lb-open`).addEventListener(`click`,async()=>{let e=document.createElement(`div`);e.className=`lb-overlay`,e.innerHTML=`
